...
export const { name: dogName, age: dogAge, breed: dogBreed } = dog;

console.log("ex 3 dogBreed: ", dogBreed);
...
console.log("ex 4 more info", moreInformation);
